package com.jagl.pickleapp.features.detail.components
    ...
    Card(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.episodes, item.episodes.count()),
                    fontSize = 24.sp,
                    style = MaterialTheme.typography.bodyMedium
                )
                Spacer(modifier = Modifier.height(4.dp))
                LazyColumn {
                    items(item.episodes.count()) { index ->
                        Text(
                            text = stringResource(R.string.episode, index + 1),
                            fontSize = 18.sp,
                            style = MaterialTheme.typography.bodySmall
                        )
                    }
