...
import com.jagl.pickleapp.core.remote.source.RemoteEpisodesDataSourceImpl
...
object RemoteDi {
    ...
    @Singleton
    @Provides
    fun provideEpisodeDataSource(api: RickAndMortyApi): RemoteEpisodesDataSource {
        return RemoteEpisodesDataSourceImpl(api)
    }
